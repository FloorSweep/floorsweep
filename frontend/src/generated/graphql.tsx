...
export type LikeEnsNameQueryVariables = Exact<{
  name?: InputMaybe<Scalars['String']>;
}>;


export type LikeEnsNameQuery = { __typename?: 'Query', domains: Array<{ __typename?: 'Domain', name?: string | null, resolvedAddress?: { __typename?: 'Account', id: string } | null }> };


export const LikeEnsNameDocument = gql`
    query likeENSName($name: String) {
  domains(first: 10, where: {name_starts_with: $name, resolvedAddress_not: null}) {
    name
    resolvedAddress {
      id
    }
    ...
    `;
export type LikeEnsNameComponentProps = Omit<ApolloReactComponents.QueryComponentOptions<LikeEnsNameQuery, LikeEnsNameQueryVariables>, 'query'>;

    export const LikeEnsNameComponent = (props: LikeEnsNameComponentProps) => (
      <ApolloReactComponents.Query<LikeEnsNameQuery, LikeEnsNameQueryVariables> query={LikeEnsNameDocument} {...props} />
    );
    
export type LikeEnsNameProps<TChildProps = {}, TDataName extends string = 'data'> = {
      [key in TDataName]: ApolloReactHoc.DataValue<LikeEnsNameQuery, LikeEnsNameQueryVariables>
    } & TChildProps;
export function withLikeEnsName<TProps, TChildProps = {}, TDataName extends string = 'data'>(operationOptions?: ApolloReactHoc.OperationOption<
  TProps,
  LikeEnsNameQuery,
  LikeEnsNameQueryVariables,
  LikeEnsNameProps<TChildProps, TDataName>>) {
    return ApolloReactHoc.withQuery<TProps, LikeEnsNameQuery, LikeEnsNameQueryVariables, LikeEnsNameProps<TChildProps, TDataName>>(LikeEnsNameDocument, {
      alias: 'likeEnsName',
      ...operationOptions
    });
};
...
/**
 * __useLikeEnsNameQuery__
 *
 * To run a query within a React component, call `useLikeEnsNameQuery` and pass it any options that fit your needs.
 * When your component renders, `useLikeEnsNameQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useLikeEnsNameQuery({
 *   variables: {
 *      name: // value for 'name'
 *   },
 * });
 */
export function useLikeEnsNameQuery(baseOptions?: Apollo.QueryHookOptions<LikeEnsNameQuery, LikeEnsNameQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<LikeEnsNameQuery, LikeEnsNameQueryVariables>(LikeEnsNameDocument, options);
      }
export function useLikeEnsNameLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<LikeEnsNameQuery, LikeEnsNameQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<LikeEnsNameQuery, LikeEnsNameQueryVariables>(LikeEnsNameDocument, options);
        }
export type LikeEnsNameQueryHookResult = ReturnType<typeof useLikeEnsNameQuery>;
export type LikeEnsNameLazyQueryHookResult = ReturnType<typeof useLikeEnsNameLazyQuery>;
export type LikeEnsNameQueryResult = Apollo.QueryResult<LikeEnsNameQuery, LikeEnsNameQueryVariables>;